    ...
    return (<div className="container">
      <div className="centerAlign" style={{marginBottom:110, paddingTop:60}}>
        <div className="centerAlign" style={{paddingBottom:40, borderBottom: '1px solid #c3c3c3'}}>
          ...
          <h2><b>Disputes Resolution</b></h2>
          <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>
          
          <h2><b>For European Union (EU) Users</b></h2>
          <p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.</p>
          
          <h2><b>United States Legal Compliance</b></h2>
          ...
          <h2><b>Translation Interpretation</b></h2>
          <p>These Terms and Conditions may have been translated if We have made them available to You on our Service.
          You agree that the original English text shall prevail in the case of a dispute.</p>

          
          <h2><b>Changes to These Terms and Conditions</b></h2>
          ...
          <h2><b>Feedback and Information</b></h2>
          <p>Any feedback you provide at this site shall be deemed to be non-confidential. Omcoin shall be free to use such information on an unrestricted basis.</p>
          <p><i>The information contained in this web site is subject to change without notice.</i>
          <br />
          <i>Copyright © 2021 Omcoin Inc. All rights reserved</i>
          <i>Omcoin Inc., 2065 Venetian Way, Winter Park, FL 32789, USA.</i></p>
          <br />
          <p>Updated by Omcoin on April 28, 2021</p>
